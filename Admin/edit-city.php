...
<head>
    ...
    <title>Edit City - Care Groups</title>
...
<body>
    <div class="main-wrapper">
        ...
        <?php
        // Check if the city ID is set in the URL and is numeric
        if (isset($_GET['id']) && is_numeric($_GET['id'])) {
            // Get the city ID from the URL
            $city_id = $_GET['id'];

            // Fetch city details from the database based on the ID
            $sql = "SELECT * FROM cities WHERE `C_ID` = $city_id";
                    ...
                    <div class="col-lg-8 offset-lg-2">
                        <form method="POST" class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="cname" id="c-name" value="<?php echo $city_name; ?>">
                            </div>
                            <div class="form-group">
                                <label for="dep">Departments<span class="text-danger">*</span></label>
                                <textarea cols="30" rows="4" class="form-control" name="depar" id="dep"><?php echo $departments; ?></textarea>
                            </div>
                            <div class="m-t-20 text-center">
                                <button class="btn btn-info submit-btn" name="submit">Save Changes</button>
                            </div>
                        </form>
