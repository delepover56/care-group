...
include_once './Admin/Components/config.php';
...
$inputSQL = "SELECT * FROM `user` WHERE `id` = '$inputID'";
$inputResult = $conn->query($inputSQL);

if ($inputResult->num_rows > 0) {
  $rows = $inputResult->fetch_assoc();

  $inputName = $rows['name'];
  $inputEmail = $rows['email'];
  $inputPhone = $rows['phone'];
}
...
if (isset($_POST['submit'])) {
  ...
  $pdoctor = $_POST['doctors'];

  // Validating form fields: Check if any field is empty
  if (empty($pname) || empty($pmail) || empty($pphone) || empty($pdisease) || empty($pdoctor)) {
    echo '<script>alert("All fields are required.")</script>';
  } else {
    // SQL query to insert appointment data into the database
    $sql = "INSERT INTO `appointments` (`A_ID`, `Patient_name`, `Patient_email`, `Patient_phone`, `Disease`, `Doctor_Name`) 
              VALUES (NULL, '$pname', '$pmail', '$pphone', '$pdisease', '$pdoctor')";

    // Executing the SQL query
    $result = $conn->query($sql);

    // Checking if the appointment submission was successful
    if ($result) {
      echo '<script>alert("Appointment Submission Success")</script>';
    } else {
...
<head>
  ...
  <title>Welcome | Care Groups</title>
...
<body>
  ...
  <header id="header" class="fixed-top">
    <div class="container d-flex align-items-center">
      ...
      <h1 class="logo me-auto"><a href="index.php" class="logo me-auto"><img src="./admin/assets/img/logo-dark.png" alt=""><span class="text-info"> Care Groups</span></a></h1>
      ...
      <nav id="navbar" class="navbar order-last order-lg-0">
        <ul>
          ...
          if (empty($_SESSION['id'])) {
            echo '<li><a class="nav-link scrollto" href="./Admin/login.php">Login</a></li>';
          } else {
            echo '<li><a class="nav-link scrollto" href="./logout.php">Sign Out</a></li>';
          }
          ?>
        </ul>
    ...
    <div id="heroCarousel" data-bs-interval="5000" class="carousel slide carousel-fade" data-bs-ride="carousel">
      ...
      <div class="carousel-inner" role="listbox">
        ...
        <div class="carousel-item active" style="background-image: url(assets/img/slide/slide-1.jpg)">
          <div class="container">
            <h2>Welcome to <span>Care Groups</span></h2>
  ...
  <main id="main">
    ...
    <section id="doctors" class="doctors section-bg">
      <div class="container" data-aos="fade-up">
        ...
        <!-- Filter Dropdown and Doctor Table -->
        <div class="row">
          <div class="box">
            <!-- Dropdown to filter doctors by city -->
          ...
          <!-- Heading for Specialist Doctors -->
          <h2 class="text-center">All Specialist Doctors</h2>
          ...
          <table class="table table-bordered table-striped table-hover">
            ...
            <tbody id="result">
              <!-- Doctor information will be displayed here dynamically -->
            </tbody>
          </table>
        </div>

        <!-- JavaScript to handle data retrieval and filtering -->
        <script type="text/javascript">
          // Function to execute once the document is ready
          $(document).ready(function() {
            // Call the showdata function to initially display all doctors
            showdata();
          });

          // Function to fetch and display all doctors
          function showdata() {
            // Using jQuery's AJAX to make a POST request to show-data.php
            $.ajax({
              url: 'show-data.php', // URL to the PHP script that retrieves all doctors
              method: 'post', // HTTP method
              success: function(result) {
                // Update the content of the HTML element with id "result" with the result from the AJAX call
                $("#result").html(result);
              }
            });
          }

          // Function to fetch and display doctors based on the selected city
          function selectdata(loc) {
            // Using jQuery's AJAX to make a POST request to select-data.php with the selected city
            $.ajax({
              url: 'select-data.php', // URL to the PHP script that retrieves doctors based on the selected city
              method: 'post', // HTTP method
              data: 'loc_name=' + loc, // Data to be sent with the request, representing the selected city
              success: function(result) {
                // Update the content of the HTML element with id "result" with the result from the AJAX call
                $("#result").html(result);
              }
    ...
    <section id="appointment" class="appointment section-bg">
      <div class="container" data-aos="fade-up">
        ...
        <div class="card" style="padding: 25px; padding-top: 30px;">
          <div class="card-body">
            <!-- Appointment Form -->
            <form action="" method="post" class="row g-3">
              ...
              <div class="row">
                <div class="col-md-4 form-group">
                  ...
                  <input type="text" name="name" class="form-control" id="name" value="<?php if (empty($inputName)) {
                                                                                          echo NULL;
                                                                                        } else {
                                                                                          echo $inputName;
                                                                                        } ?>">
                ...
                <div class="col-md-4 form-group mt-3 mt-md-0">
                  ...
                  <input type="email" class="form-control" name="email" id="email" value="<?php if (empty($inputEmail)) {
                                                                                            echo NULL;
                                                                                          } else {
                                                                                            echo $inputEmail;
                                                                                          } ?>">
                ...
                <div class="col-md-4 form-group mt-3 mt-md-0">
                  ...
                  <input type="tel" class="form-control" name="phone" id="phone" value="<?php if (empty($inputPhone)) {
                                                                                          echo NULL;
                                                                                        } else {
                                                                                          echo $inputPhone;
                                                                                        } ?>">
              ...
              <div class="row">
                <div class="col-md-4 form-group mt-3">
                  <label for="name">Your Disease:</label>
                  <input type="tel" class="form-control" name="disease" id="disease">
                </div>
                <div class="col-md-4 form-group mt-3">
                  <label for="name">Select Your Doctor:</label>
                  <select name="doctors" id="doctor" class="form-select">
                    <option value="" disabled selected>Select Doctor</option>
                    <option value="James Bond">James Bond</option>
                    <option value="Penny Wise">Penny Wise</option>
                    <option value="John Wick">John Wick</option>
                    <option value="Mr Bean">Mr Bean</option>
                    <option value="Dr. Sarah Johnson">Dr. Sarah Johnson</option>
                    <option value="Dr. Michael Anderson">Dr. Michael Anderson</option>
                    <option value="Dr. Emily Martinez">Dr. Emily Martinez</option>
                  </select>
                </div>
              </div>
